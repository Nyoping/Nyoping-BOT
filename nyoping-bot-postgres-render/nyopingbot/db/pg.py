...
# welcome/goodbye settings
        ...
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_image_enabled BOOLEAN NOT NULL DEFAULT FALSE;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_background_url TEXT NOT NULL DEFAULT '';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_avatar_shape TEXT NOT NULL DEFAULT 'circle';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_avatar_x INTEGER NOT NULL DEFAULT 40;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_avatar_y INTEGER NOT NULL DEFAULT 40;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_avatar_w INTEGER NOT NULL DEFAULT 128;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_avatar_h INTEGER NOT NULL DEFAULT 128;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text_template TEXT NOT NULL DEFAULT '[user]';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text_x INTEGER NOT NULL DEFAULT 200;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text_y INTEGER NOT NULL DEFAULT 80;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text_font_size INTEGER NOT NULL DEFAULT 40;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text_color TEXT NOT NULL DEFAULT '#ffffff';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text_align TEXT NOT NULL DEFAULT 'left';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text_font_name TEXT NOT NULL DEFAULT 'default';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text_box_width INTEGER NOT NULL DEFAULT 500;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text2_template TEXT NOT NULL DEFAULT '';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text2_x INTEGER NOT NULL DEFAULT 200;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text2_y INTEGER NOT NULL DEFAULT 140;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text2_font_size INTEGER NOT NULL DEFAULT 32;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text2_color TEXT NOT NULL DEFAULT '#ffffff';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text2_align TEXT NOT NULL DEFAULT 'left';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text2_font_name TEXT NOT NULL DEFAULT 'default';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text2_box_width INTEGER NOT NULL DEFAULT 500;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text3_template TEXT NOT NULL DEFAULT '';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text3_x INTEGER NOT NULL DEFAULT 200;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text3_y INTEGER NOT NULL DEFAULT 200;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text3_font_size INTEGER NOT NULL DEFAULT 28;")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text3_color TEXT NOT NULL DEFAULT '#ffffff';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text3_align TEXT NOT NULL DEFAULT 'left';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text3_font_name TEXT NOT NULL DEFAULT 'default';")
        await conn.execute("ALTER TABLE guild_settings ADD COLUMN IF NOT EXISTS welcome_text3_box_width INTEGER NOT NULL DEFAULT 500;")
