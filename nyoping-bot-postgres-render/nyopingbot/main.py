...
EXTENSIONS = [
    ...
    "nyopingbot.cogs.community_features",
]
    ...
    async def _sync_caches_background(self) -> None:
        ...
        while not self.is_closed():
            try:
                ...
                for g in guilds:
                    try:
                        await upsert_guild_cache(self.db_pool, int(g.id), str(getattr(g, "name", "") or g.id))
                    except Exception:
                        pass
                    ...
                    for idx, m in enumerate(members):
                        try:
                            await upsert_member_cache(
                                ...
                                getattr(getattr(m, "display_avatar", None), "url", None),
    ...
    async def on_member_update(self, before: discord.Member, after: discord.Member) -> None:
        ...
        try:
            await upsert_member_cache(
                ...
                getattr(getattr(after, "display_avatar", None), "url", None),
